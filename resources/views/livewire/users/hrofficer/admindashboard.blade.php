...
@endif
    <div class="w-full h-screen bg-whitey relative flex flex-col" >
        <div class="w-full h-auto flex lgr:pt-3 lgr:pb-3 cursor-pointer flex-col justify-center items-center hover:bg-yellow-green mt-10 {{ Route::is('admin.users.employee') == true ? 'bg-yellow-green text-black' : '' }}" >
