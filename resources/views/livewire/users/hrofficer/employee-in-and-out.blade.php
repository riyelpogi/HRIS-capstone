            ...
            <table>
                ...
                @foreach ($tickets as $tckt)
                    <tr>
                        ...
                        <td class="text-xs text-center"><span class="text-blue-400 cursor-pointer xsmr:hidden smr:hidden" wire:click="showProof('{{ $tckt->file_name }}')" wire:key="proof-{{ $tckt->id }}">{{ $tckt->file_name }}</span>
                        <span class="text-blue-400 cursor-pointer mdr:hidden lgr:hidden xlr:hidden 2xlr:hidden 3xlr:hidden" wire:click="showProof('{{ $tckt->file_name }}')" wire:key="proof-{{ $tckt->id }}"> Proof </span>
                        </td>
