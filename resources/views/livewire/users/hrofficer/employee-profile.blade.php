...
@endif
    ...
    <div class="w-11/12 smr:2-10- m-5 relative bg-white rounded flex xsmr:flex-col smr:flex-col smr:gap-5">
        @if ($content == 'INFORMATION')
            <div class="w-1/4 smr:w-full xsmr:w-full flex flex-col items-center rounded">
        ...
        <div class="w-10/12 bg-white xsmr:w-full xsmr:ml-0 smr:w-full rounded ml-5 smr:ml-0 relative ">
            <div class="w-full">
                            ...
                            <div class="w-full relative flex flex-col">
                                <div class="flex justify-between mt-3">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right">{{$user->employee_id}}</h1>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between mt-5">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right">{{$user->position}}</h1>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between mt-5">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right">{{$user->employee_information->date_regular}}</h1>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between mt-5">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right">{{$user->employee_information->country}}</h1>
                                    </div>
                                </div>
                                ...
                                <div class="flex justify-between mt-5">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right ">{{$user->employee_information->region}}</h1>
                                    ...
                                    <div class="ml-3">
                                     ...
                                     <div class="mr-3 bg-whiterelative">
                                        <x-label class="text-right">City:</x-label>
                                          <h1 class="font-semibold text-sm text-right">{{$user->employee_information->city}}</h1>
                                     </div>
                                </div>
                                ...
                                <div class="flex justify-between mt-5">
                                    ...
                                    <div class="mr-3">
                                        ...
                                        <h1 class="font-semibold text-sm text-right">{{$user->employee_information->mobile_number}}</h1>
                                    </div>
                                </div>
                ...
                <div class="w-full relative xsmr:flex-col smr:flex-col  items-center justify-center flex p-2 flex-wrap gap-5">
                    <div class="w-full relative flex justify-end items-center gap-5">
                    ...
                    @if ($user->two_zero_one_file)
                            <div class="w-3/12 flex  xsmr:w-full smr:w-full overflow-x-hidden flex-col justify-center items-center p-2 relative border cursor-pointer rounded">
                                <h1 class="text-sm  font-semibold text-center">SSS</h1>
                                <h1 class="cursor-pointer text-xs text-center hover:text-red-400" wire:click="downloadSss('{{ $user->two_zero_one_file->sss }}')">
                            {{ $user->two_zero_one_file->sss  }}</h1>
                            </div>

                    <div class="w-3/12 flex flex-col  xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        <h1 class="text-sm  font-semibold text-center">TIN</h1>
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs" wire:click="downloadTin('{{ $user->two_zero_one_file->tin }}')">
                          {{   $user->two_zero_one_file->tin }}
                        </h1>
                     </div>

                     <div class="w-3/12 xsmr:w-full smr:w-full flex flex-col overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        <h1 class="text-sm font-semibold text-center ">PHILHEALTH</h1>
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs" wire:click="downloadPhilhealth('{{ $user->two_zero_one_file->philhealth }}')">
                     ...
                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        ...
                        <h1 class="cursor-pointer hover:text-red-400 bg-blue-600 text-xs" wire:click="downloadNbi('{{ $user->two_zero_one_file->nbi }}')">
                       {{ $user->two_zero_one_file->nbi  }}</h1>
                     </div>

                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        <h1 class="text-sm  font-semibold text-center">DIPLOMA</h1>
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs" wire:click="downloadDiploma('{{ $user->two_zero_one_file->diploma }}')">
                       {{ $user->two_zero_one_file->diploma  }}</h1>
                     </div>

                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        <h1 class="text-sm  font-semibold text-center">TOR</h1>
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs" wire:click="downloadTor('{{ $user->two_zero_one_file->tor }}')">
                     ...
                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        ...
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs">
                     ...
                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                        ...
                        <h1 class="cursor-pointer hover:text-red-400 text-center text-xs" wire:click="downloadContracts('{{ $user->two_zero_one_file->employment_contracts }}')">
                            {{ $user->two_zero_one_file->employment_contracts }}
                        </h1>
                     </div>
                     @foreach ($other_requirements_file_name as $key => $file)
                     <div class="w-3/12 flex flex-col xsmr:w-full smr:w-full justify-center items-center overflow-x-hidden p-2 relative border cursor-pointer rounded">
                        <h1 class="text-sm  font-semibold text-center uppercase  ">{{ $file[0] }}</h1>
                        <h1 class="cursor-pointer hover:text-red-400 w-full  relative overflow-x-hidden overflow-y-hidden text-xs text-center text-wrap" wire:click="downloadOthers('{{ $file[1] }}')" wire;key="others-{{ $key }}">
                            {{ $file[1]}}
                        </h1>
                     </div>
                     @endforeach
    ...
    <div class="w-full relative justify-center items-center flex">
        <div class="w-full relative flex bg-whitey p-5  flex-col justify-center items-center">
            <form wire:submit='requirementUpload' enctype="multipart/form-data">
                ...
                <div class="w-full relative flex flex-col mt-5 mb-5">
                    <x-label for="file_upload">File:</x-label>
                    <x-label for="file_upload" class="text-xs  mdr:hidden lgr:hidden xlr:hidden 2xlr:hidden 3xlr:hidden p-2 rounded-lg w-full cursor-pointer hover:bg-yellow-green border">Upload File:</x-label>
                    <input type="file" wire:model='file_upload' id="file_upload" class="xsmr:hidden smr:hidden" name="file_upload">
                    @error('file_upload')
                        <span class="text-xs text-red-200">{{ $message }}</span>
                    @enderror
                </div>
