            ...
            <div class="w-full">
                ...
                <div class="w-full relative xsmr:flex-col smr:flex-col  items-center justify-center flex p-2 flex-wrap gap-5">
                    ...
                    @if ($user->two_zero_one_file)
                            <div class="w-3/12 flex overflow-x-hidden flex-col justify-center items-center p-2 relative border cursor-pointer rounded">
                    ...
                    <div class="w-3/12 flex flex-col overflow-x-hidden justify-center items-center p-2 relative border cursor-pointer rounded">
                     ...
                     <div class="w-3/12 flex flex-col justify-center items-center overflow-x-hidden p-2 relative border cursor-pointer rounded">
