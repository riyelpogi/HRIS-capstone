            ...
            <div class="w-full relative flex  bg-gray-100 flex-wrap gap-5">
                ...
                <div class="w-full relative flex flex-wrap gap-5">
                    @if (auth()->user()->two_zero_one_file)
                            <div class="w-3/12 flex flex-col justify-center items-center p-2 overflow-x-hidden relative bg-whitey">
                            ...
                            <div class="w-3/12 flex flex-col justify-center items-center p-2 overflow-x-hidden relative bg-whitey">
                             ...
                             <div class="w-3/12 flex flex-col justify-center overflow-x-hidden bg-red-200 items-center p-2 relative bg-whitey">
                             ...
                             <div class="w-3/12 flex flex-col justify-center items-center overflow-x-hidden p-2 relative bg-whitey">
        ...
        <div class="w-full relative flex bg-whitey p-5  flex-col justify-center items-center">
            <form wire:submit='requirementUpload' enctype="multipart/form-data">
                ...
                <div class="w-full relative flex flex-col mt-5 mb-5">
                    ...
                    <x-label for="file_image" class="text-xs  mdr:hidden lgr:hidden xlr:hidden 2xlr:hidden 3xlr:hidden p-2 rounded-lg w-full cursor-pointer hover:bg-yellow-green border {{$file_image != null ? 'bg-yello-green' : ''}}">Upload File:</x-label>
