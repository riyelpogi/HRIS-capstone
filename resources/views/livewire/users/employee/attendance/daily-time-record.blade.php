    ...
    @elseif($content == 'MYTICKETS') 
                <div class="w-full relative flex justify-center items-center">
                    <table class="w-full relative " wire:poll>
                        ...
                        <tr class="{{ $ticket->id == $ticket_id ? 'bg-red-200' : '' }} w-40 relative overflow-x-hidden ">
                            ...
                            <td class="text-xs w-40 relative text-center text-wrap "><span class="cursor-pointer xsmr:hidden smr:hidden w-full hover:text-blue-200" wire:click="showImageModal('{{ $ticket->file_name }}')" wire:key="show-image-modal-{{ $ticket->id }}">
                                {{$ticket->file_name}}</span>
                                <span class="mdr:hidden lgr:hidden xlr:hidden 2xlr:hidden 3xlr:hidden cursor-pointer w-full  overflow-x-hidden hover:text-blue-200" wire:click="showImageModal('{{ $ticket->file_name }}')" wire:key="show-image-modal-{{ $ticket->id }}">Proof</span>
                                </td>
