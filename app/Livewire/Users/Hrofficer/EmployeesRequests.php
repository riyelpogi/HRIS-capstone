        ...
        if(Gate::allows('admin')){
            ...
            if ($f_year == $t_year) {
                ...
                $count = 0;
                    ...
                    $leave_credits->leave_credit = $leave_credits->leave_credit - $count;
                    $leave_credits->save();
    ...
    public function approveRequestOff($id)
    {
            ...
            if(Gate::allows('admin')){
                ...
                if ($r_month == 1) {
                    ...
                    if($user_sched->r_day != 'LEAVE' || $user_sched->r_day != 'On Training'){
